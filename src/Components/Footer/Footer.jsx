...
const Footer = () => {
  return (
    <div className="flex flex-col space-y-4">
      <div className="text-center font-Montserrat tracking-wider">
        <Link to="/sisi">
          Content <span className="text-textStrong">Creation</span> Page
        </Link>
      </div>
      <div className="py-12 lg:py-10 border-t border-strongBgColor">
        <Container maxWidth="lg" className="flex flex-col">
          <div className="grid grid-flow-row grid-cols-1 lg:grid-cols-2 gap-y-5 lg:gap-y-0">
