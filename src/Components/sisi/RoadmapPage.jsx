                  ...
                  <div className="max-w-4xl mx-auto">
                    {roadmap ? (
                      roadmaps.map((roadmap) => (
                        <div key={roadmap.id} className="mb-10 p-6 shadow-lg">
                          <h2 className="text-2xl font-bold mb-2">
                            {roadmap.title}
                          </h2>
                          <p className="mb-6">{roadmap.description}</p>
                          ...
                          <h3 className="text-xl font-semibold mt-8 text-textStrong text-center">
                            Concepts:
                          </h3>
                          ...
                          <div>
                            <h3 className="text-xl font-semibold mt-8 text-center text-textStrong ">
                              Interview Tips:
                            </h3>
