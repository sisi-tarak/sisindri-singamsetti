        ...
        <Box className="flex justify-center">
          ...
          <Box className="flex flex-col justify-center mt-8 w-[650px] px-8">
            <p className="text-textColor font-normal text-base font-Montserrat">
              Hi, I’m Sisindri Singamsetti! I’m a passionate web developer with
              a keen focus on{" "}
              ...
              can solve real-world problems. From the start, I’ve been
              fascinated by building efficient, responsive, and scalable
              applications that deliver seamless user interactions. <br />{" "}
              <br />
              I’ve spent countless hours honing my skills, experimenting with
              new tools, and exploring various technologies to craft dynamic,
