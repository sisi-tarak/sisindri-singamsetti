          ...
          <div className="opacity-90 hover:opacity-100 transition-all duration-500 ease-in-out">
            ...
            <div className="my-5">
              ...
              <p className="text-xs sm:text-sm font-poppins mt-2 tracking-wide">
                A collection of frequently asked React interview questions to
                help you prepare, providing insight into potential topics
                without focusing on memorization.
              </p>
            </div>
          </div>
        </Fade>
          ...
          <div className="opacity-90 hover:opacity-100 transition-all duration-500 ease-in-out">
            ...
            <div className="my-5">
              ...
              <p className="text-xs sm:text-sm font-poppins mt-2 tracking-wide">
                ...
                skills, practical projects, and advanced techniques to shape
                your career.
              </p>
            </div>
          </div>
        ...
        <Fade blur={true}>
          <div className="opacity-90 hover:opacity-100 transition-all duration-500 ease-in-out">
            ...
            <div className="my-5">
              ...
              <p className="text-xs sm:text-sm font-poppins mt-2 tracking-wide">
                Explore various resume formats tailored to different career
                stages and job requirements, designed to highlight your skills
                effectively.
              </p>
            </div>
          </div>
          ...
          <div className="opacity-90 hover:opacity-100 transition-all duration-500 ease-in-out">
            ...
            <div className="my-5">
              ...
              <p className="text-xs sm:text-sm font-poppins mt-2 tracking-wide">
                ...
                workflows, and precautions for reliable version control
                practices.
              </p>
            </div>
          </div>
